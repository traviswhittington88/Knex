...
describe(`Articles service object`, function() {
    ...
    afterEach(() => db('blogful_articles').truncate())  // this removes rows from table after each test
    after(() => db.destroy())
    ...
    context(`Given 'blogful_articles' has data`, () => {
        ...
        it(`updateArticle() updates an article from 'blogful_articles' table`, () => {  
            ...
            return ArticlesService.updateArticle(db, idOfArticleToUpdate)
    ...
    context(`Give 'blogful_articles' has no data`, () => {
